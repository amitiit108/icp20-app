...
const fetcher = (query) => request('https://api.thegraph.com/subgraphs/name/soolking-cyber/icpnew', query)
...
function Stake() {
  ...
  const { data } = useSWR(`{bar(id: "0xf947becbda661dc3e9fd8f6c666fad170a7e9050") {ratio, totalSupply}}`, fetcher)
