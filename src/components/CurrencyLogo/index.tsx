...
const unknown = 'https://app.icp-20.com/_next/image?url=%2Fimages%2Ftokens%2Fsticp.png&w=48&q=75'
...
const CurrencyLogo: FunctionComponent<CurrencyLogoProps> = ({
  ...
  if (currency && currency.isToken) {
    if (currency instanceof WrappedTokenInfo && currency.chainId === ChainId.MATIC) {
      ...
      if (currency.tokenInfo.address.toLowerCase() === '0xf947becbda661dc3e9fd8f6c666fad170a7e9050') {
        return (
          <Image
